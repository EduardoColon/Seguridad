...
{
    public partial class frm_modificarPermisosPerfiles : Form
    {
        logica logic;
        public frm_modificarPermisosPerfiles(string idUsuario)
        {
            InitializeComponent();
        ...
        private void Frm_modificarPermisosPerfiles_Load(object sender, EventArgs e)
        {
        ...
        private void Btn_agregar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                txt_perfil.Text = sPerfil;
                txt_aplicacion.Text = sAplicacion;

                try
                {
                    DataTable dtPermisos = logic.consultaLogicaPermisosPerfiles(sPerfil, sAplicacion);
        ...
        private void Btn_finalizar_Click(object sender, EventArgs e)
        {
            ...
            sPerfil = txt_perfil.Text;
            sAplicacion = txt_aplicacion.Text;

            if (txt_perfil.Text== "" || txt_aplicacion.Text == "")
            {
            ...
            else
            {
                try
                {
                    ...
                    DataTable dtPermisos = logic.consultaLogicaModificarPermisosPerfiles(sPerfil, sAplicacion, sIngresar, sConsulta, sModificar, sEliminar, sImprimir);
